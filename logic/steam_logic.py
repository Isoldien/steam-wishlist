...
def getWishlist() :
    ...
    for games in wishlist :
        appid = games['appid']
        #@TODO 
        # Python Wrapper for SteamAPI doesn't specifically provide name and price
        # Which would require cleaning the data generated by the API 
        # Other option is to use Requests

        r = steam.apps.get_app_details(appid)

        print(r.get('price_overview'))
